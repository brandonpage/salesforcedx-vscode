...
describe('activation modes', () => {
  ...
  it('activates every time when activationMode is set to always', async () => {
  ...
  it('activates every time when activationMode is set to always for non LWC projects', async () => {
    const EXPECTED = 'always';
  ...
  it('does not activate when activationMode is set to off', async () => {
    const logMessage =
  ...
  it('conditionally activates when activationMode is set to autodetect for LWC projects', async () => {
  ...
  it('does not activate when activationMode is set to autodetect for non-LWC projects', async () => {
    const EXPECTED = 'autodetect';
    const mockConfiguration = stubObject<vscode.WorkspaceConfiguration>(
      vscode.workspace.getConfiguration('salesforcedx-vscode-lightning'),
      {
